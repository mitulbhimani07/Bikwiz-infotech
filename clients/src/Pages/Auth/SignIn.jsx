      ...
      <div className={`max-w-md w-full p-8 rounded-lg  ${textColor} transition-colors duration-300`}>
        <div className="flex justify-between items-center mb-6">
          <div className="flex items-center">
            ...
            <span className="ml-2 font-bold text-lg">Bikwiz Infotech</span>
          </div>
          <button
            onClick={toggleTheme}
        ...
        <div className="space-y-3">
          <button
            type="button"
            className={`w-full flex justify-center items-center py-3 px-4 border ${inputBorderColor} rounded-md shadow-sm ${inputBgColor} text-sm font-medium ${textColor} hover:bg-gray-50 dark:hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 transition-colors duration-200`}
          >
