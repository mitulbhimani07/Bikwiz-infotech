        ...
        <>
            <div className="min-h-screen flex flex-col lg:flex-row bg-[#fff0e5]">
                ...
                <div className="flex flex-col flex-1 min-w-0"> {/* Changed to w-0 to allow flex-grow */}
                    ...
                    <div className="w-full px-6 py-6 max-w-[calc(100vw-80px)]"> {/* Adjusted width */}
                        <div className=" "> {/* Constrained width */}
                            <h1 className="text-2xl font-bold text-orange-500 mb-6">Applicant Details</h1>
                            <div className="flex flex-col lg:flex-row gap-6 bg-white rounded-3xl p-6 overflow-hidden"> {/* Added overflow-hidden */}
                                {/* Left Column */}
                                <div className="lg:w-1/3 space-y-6 min-w-0"> {/* Added min-w-0 */}
                                ...
                                {/* Right Column */}
                                <div className="lg:w-2/3 min-w-0"> {/* Changed width and added min-w-0 */}
                                    <div className="bg-white border border-orange-500 min-w-0"> {/* Added min-w-0 */}
                                        {/* Tabs */}
                                        <div className="border-b mx-6 border-orange-500 overflow-x-auto"> {/* Added overflow-x-auto */}
                                            <div className="flex min-w-max"> {/* Added min-w-max */}
                                                {tabs.map((tab) => (
                                                    <button
                                                        key={tab}
                                                        onClick={() => setActiveTab(tab)}
                                                        className={`px-4 py-4 text-sm font-medium border-b-6 whitespace-nowrap ${activeTab === tab
                                        ...
                                        {/* Tab Content */}
                                        <div className="p-6 min-w-0"> {/* Added min-w-0 */}
                                                    ...
                                                    <div>
                                                        ...
                                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                                            <div>
                                                                ...
                                                                <p className="text-sm font-medium text-gray-900">Graham Dhanani</p>
                                                            </div>
                                                            <div>
                                                            ...
                                                            <div>
                                                                ...
                                                                <p className="text-sm font-medium text-gray-900">March 23, 1995 <span className="text-gray-500">(26 y.o)</span></p>
                                                            </div>
                                                            <div>
                                                                <p className="text-sm text-gray-600 mb-1">Language</p>
                                                                <p className="text-sm font-medium text-gray-900">English, Hindi, Marathi</p>
                                                            </div>
                                                            <div className="md:col-span-2">
                                                                <p className="text-sm text-gray-600 mb-1">Address</p>
                                                                <p className="text-sm font-medium text-gray-900">441, Ar Mall Parvel Point, Mota Varacha, surat.</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div className='border-b-2 border-orange-500'></div>
                                                        ...
                                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                                            ...
                                                            <div>
                                                                ...
                                                                <div className="flex flex-wrap gap-2">
                                                                    <span className="px-3 py-1 text-orange-500 text-sm font-medium bg-[#FFF0E5]">Project Management</span>
                                                                    <span className="px-3 py-1 text-orange-500 text-sm font-medium bg-[#FFF0E5]">Copywriting</span>
                                                                    <span className="px-3 py-1 text-orange-500 text-sm font-medium bg-[#FFF0E5]">English</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            {activeTab === 'Hiring Progress' && (
                                                <div className="space-y-6">
                                                    ...
                                                    <div className="flex justify-between items-center mb-6">
                                                        ...
                                                        <button className="flex items-center gap-2 text-orange-600 border border-orange-500 px-4 py-3 hover:bg-orange-50 text-sm font-semibold">
                                                    ...
                                                    <div className="grid grid-cols-4 text-sm font-medium text-center mb-6 overflow-hidden">
                                                        <div className="font-semibold text-sm mx-1 bg-[#FFF0E5] py-5 text-orange-600">In-Review</div>
                                                        <div className="font-semibold text-sm mx-1 bg-[#FFF0E5] py-5 text-orange-600">Shortlisted</div>
                                                        <div className="font-semibold text-sm mx-1 bg-orange-500 text-white py-5">Interview</div>
                                                        <div className="font-semibold text-sm mx-1 bg-[#FFF0E5] py-5 text-orange-600">Hired/Declined</div>
                                                    </div>
                                                    ...
                                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-6">
                                                        ...
                                                        <div>
                                                            ...
                                                            <div className="flex mt-2 space-x-[-10px]">
                                                                <img src="https://i.pravatar.cc/30?img=1" className="w-8 h-8 rounded-full border-1 border-white" alt="avatar" />
                                                                <img src="https://i.pravatar.cc/30?img=2" className="w-8 h-8 rounded-full border-1 border-white" alt="avatar" />
                                                                <img src="https://i.pravatar.cc/30?img=3" className="w-8 h-8 rounded-full border-1 border-white" alt="avatar" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div className="border-t border-orange-500 pt-6">
                                                        ...
                                                        <div className="bg-[#FFF0E5] p-4 mb-4">
                                                            <div className="flex items-start gap-3">
                                                                <img src="https://i.pravatar.cc/40?img=4" className="w-10 h-10 rounded-full" alt="avatar" />
                                                                <div>
                                            ...
                                            {activeTab === 'Interview Schedule' && (
                                                <div className="py-6 space-y-6">
                                                    ...
                                                    <div className="space-y-3">
                                                        ...
                                                        {/* Interview Card */}
                                                        <div className="bg-[#FFF7F2] p-4 rounded-md flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                                                            ...
                                                            <div className="text-sm text-gray-600 sm:text-right min-w-0">
                                                                <p className="text-gray-900 font-semibold">10:00 AM - 11:30 AM</p>
                                                                <p className="truncate">Silver Crysta Room, Nomad</p>
                                                            </div>

                                                            <div className="flex items-center gap-2 w-full sm:w-auto">
                                                                <button className="flex-1 sm:flex-none flex items-center gap-2 border border-orange-500 text-orange-500 text-sm px-3 py-2 font-semibold hover:bg-orange-50">
                                                    ...
                                                    {/* Additional interview cards would go here */}
                                                </div>
                                            )}
                                        </div>
                                    </div>
