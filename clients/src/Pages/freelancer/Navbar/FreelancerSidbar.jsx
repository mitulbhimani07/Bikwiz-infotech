...
export default function FreelancerSidebar() {
  ...
  return (
    <>
      ...
      {isMobileMenuOpen && (
        <div
          className="lg:hidden fixed inset-0 bg-[#00000037] bg-opacity-50 z-[900] backdrop-blur-sm"
          onClick={toggleMobileMenu}
        />
      )}
...
function NavItem({ icon: Icon, label, to, active = false, onClick }) {
  return (
    <Link
      to={to}
      onClick={onClick}
      className={`flex items-center gap-3 w-full text-left px-3 lg:px-4 py-3 rounded-lg transition-all duration-200 text-sm lg:text-base no-underline relative overflow-hidden ${active
