        ...
        <div className="flex flex-col md:flex-row gap-6 justify-center mb-10">
          ...
          <div 
            className={`border rounded-lg px-20 py-10 flex flex-col items-center cursor-pointer transition relative ${
              selected === 'expert' ? 'border-[#F54900] shadow-md' : 'border-gray-200 hover:border-gray-300'
            }`}
          ...
          <div 
            className={`border rounded-lg px-20 py-10 flex flex-col items-center cursor-pointer transition relative ${
              selected === 'business' ? 'border-[#F54900] shadow-md' : 'border-gray-200 hover:border-gray-300'
            }`}
