      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row md:justify-between">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-8 w-full md:w-3/4">
            ...
            {/* Newsletter Column - Spans full width on mobile, auto on larger screens */}
            <div className="col-span-2 md:col-span-3">
              <h3 className="font-semibold text-base mb-4">Newsletter</h3>
              <p className="mb-3">Join & get important new regularly</p>
              <div className="flex">
                <input 
                  type="email" 
                  placeholder="Enter your email" 
                  className="p-2 border border-gray-300 rounded-l focus:outline-none focus:ring-1 focus:ring-green-500 flex-grow"
                />
                <button className="bg-gray-800 text-white py-2 px-4 rounded-r hover:bg-gray-700">
                  Send
                </button>
              </div>
